...
QT_MOC_LITERAL(1, 11, 12), // "jsonReceived"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "json"
QT_MOC_LITERAL(4, 30, 8), // "sendJson"
QT_MOC_LITERAL(5, 39, 4), // "loop"
QT_MOC_LITERAL(6, 44, 15) // "requestFinished"

    },
    "WebService\0jsonReceived\0\0json\0sendJson\0"
    "loop\0requestFinished"
};
...
void WebService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WebService *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->jsonReceived((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 1: _t->sendJson((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        ...
        {
            using _t = void (WebService::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WebService::jsonReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WebService::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_WebService.data,
    qt_meta_data_WebService,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void WebService::jsonReceived(QJsonObject _t1)
{
