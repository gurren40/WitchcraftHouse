...
--
-- Host: localhost
-- Generation Time: Feb 06, 2019 at 09:20 PM
...
CREATE TABLE `ControlDevice` (
  `controlDeviceID` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `controlDeviceName` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `controlDeviceToken` varchar(101) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `Device` (
  ...
  `deviceToken` varchar(101) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- AUTO_INCREMENT for table `ControlDevice`
--
ALTER TABLE `ControlDevice`
  MODIFY `controlDeviceID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `Shared`
  ADD CONSTRAINT `Shared_ibfk_1` FOREIGN KEY (`pinID`) REFERENCES `Pin` (`pinID`),
